...
- (void)showActionSheetViewWithTitle:(NSString *)alertTitle withMessage:(NSString *)message actionTitleArr:(NSArray *)actionTitleArr withViewController:(UIViewController *)viewController withReturnCodeBlock:(ActionBlockNumber)actionBlockNumber {
    
    UIAlertController *alertC = [UIAlertController alertControllerWithTitle:alertTitle message:message preferredStyle:UIAlertControllerStyleActionSheet];
